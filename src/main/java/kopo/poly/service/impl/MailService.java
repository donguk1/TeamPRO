...
public class MailService implements IMailService {
    ...
    public int doSendMail(MailDTO pDTO) {
        ...
        String toMail = kopo.poly.Util.CmmUtil.nvl(pDTO.getToMail()); // 받는이
        String title = kopo.poly.Util.CmmUtil.nvl(pDTO.getTitle()); // 메일제목
        String contents = kopo.poly.Util.CmmUtil.nvl(pDTO.getContents()); // 메일내용
